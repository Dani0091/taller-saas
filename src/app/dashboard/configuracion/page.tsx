    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="p-4 md:p-6 shadow-sm">
          ...
          {/* Configuración de Citas y Calendario */}
          <Card className="p-6 md:p-8 shadow-sm">
            <div className="flex items-center gap-2 mb-6 pb-4 border-b">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-sky-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                <line x1="16" y1="2" x2="16" y2="6"/>
                <line x1="8" y1="2" x2="8" y2="6"/>
                <line x1="3" y1="10" x2="21" y2="10"/>
              </svg>
              <h2 className="text-xl font-bold">Citas y Calendario</h2>
            </div>

            <p className="text-sm text-gray-600 mb-6">
              Configura el sistema de citas y calendario del taller. Puedes activar o desactivar esta funcionalidad
              para todo el equipo.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                <div>
                  <h3 className="font-semibold">Sistema de citas</h3>
                  <p className="text-sm text-gray-500">
                    Permite gestionar citas y avisos desde el menú principal
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    readOnly
                  />
                  <div className="w-11 h-6 bg-sky-600 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                </label>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Enviar recordatorios por WhatsApp/SMS a los clientes (próximamente)
                  </p>
                </div>
              ...
              <div className="p-4 bg-gray-50 rounded-lg border">
                <h3 className="font-semibold mb-3">Horario del taller</h3>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Las citas solo se podrán crear dentro de este horario
                </p>
              </div>

              {/* Duración por defecto */}
              <div className="p-4 bg-gray-50 rounded-lg border">
                <h3 className="font-semibold mb-3">Duración por defecto de citas</h3>
                <select defaultValue="60" className="w-full px-3 py-2 border rounded-lg">
